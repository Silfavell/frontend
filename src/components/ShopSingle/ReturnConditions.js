        ...
        return (
            <div className='border-bottom p-4'>
                <div className='col-md-12'>
                    <b style={{ fontSize: 20 }} className='text-black'>İptal Koşulları:</b>
