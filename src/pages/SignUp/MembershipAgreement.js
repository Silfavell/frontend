                    ...
                    <div className='col-md-12'>
                        <p className='p-lg-5' style={{ whiteSpace: 'break-spaces' }}>
                            ...
                            <p>
                                ...
                                {' '}
                                Bu sözleşme silfavell.com sitesine üye olmak isteyen internet kullanıcısı (sözleşmenin devam eden hükümlerinde üye olarak anılacaktır) ile Silfavell şirketi (sözleşmenin devam eden hükümlerinde Silfavell olarak anılacaktır) arasında akdedilmiştir.
                            </p>

                            <p>
                                <b className='text-black'>2 -</b>
                                {' '}
                                Bu sözleşme Silfavell’e ait internet sitesinden üyenin faydalanmasına ilişkin şartları ve üyelik ilişkisine ilişkin hak ve borçları düzenler
                            </p>
                            ...
                            <p>
                                ...
                                {' '}
                                Üye, üyelik ilişkisini internet sitesinde bu hak için ayrılmış bölümden her zaman sona erdirebilir. Silfavell, üyelik ilişkisini her zaman herhangi bir neden göstermeksizin veya üyenin üyelik sözleşmesinden kaynaklanan yükümlülüklerinden birini ihlal etmesi üzerine tek taraflı olarak sona erdirebilir.
                            </p>

                            <p>
                                <b className='text-black'>D -</b>
                                {' '}
                            ...
                            <p>
                                ...
                                {' '}
                                Bu sözleşme Türk Hukukuna tabidir. Bu sözleşmeden kaynaklanan uyuşmazlıklarda İstanbul Mahkemeleri ve İcra Daireleri yetkili ve görevlidir.
                            </p>

                            <p>
                                <b className='text-black'>E -</b>
                                {' '}
                                Yürürlük
                            </p>
...
export default PopupWrapperHoc(MembershipAgreement)
