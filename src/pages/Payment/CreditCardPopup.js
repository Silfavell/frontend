...
class NewCreditCardPopup extends React.Component {
    ...
    onCardNumberChange = (event) => {
        ...
        joi.string()
            ...
            .min(16)
            .max(16)
            .validateAsync(value.split(' ').join(''))
            .then(() => {
                ...
                <div className='m-3 p-lg-5'>
                    ...
                    <div className='form-group row'>
                        <div className='col-md-12'>
                            <label htmlFor='cardAlias' className='text-black'>
                                Kart etiketi
                    ...
                    <div className='form-group row'>
                        <div className='col-md-6'>
                            <label htmlFor='expireMonth' className='text-black'>
                                Ay
                                <span className='text-danger'>*</span>
                            </label>
                            <select
                        ...
                        <div className='col-md-6'>
                            <label htmlFor='expireYear' className='text-black'>
                                Yıl
                                <span className='text-danger'>*</span>
                            </label>
                            <select
