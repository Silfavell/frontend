        ...
        return (
            <div className='border-bottom p-4'>
                <div className='col-md-12'>
                    ...
                    <p className='mt-3 font-weight-bolder' style={{ whiteSpace: 'break-spaces', fontSize: 16 }}>
